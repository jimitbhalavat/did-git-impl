...
test_expect_success GPG 'create signed commits' '
	test_when_finished "test_unconfig commit.sign" &&
	...
	# commit.sign is still on but this must not be signed
...
test_expect_success GPG 'check config signing.default values' '
	test_config signing.default openpgp &&
